...
export const truckFreightSchema = z
  .object({
    ...
    advance: z.coerce
      .number({ required_error: "Advance is required", invalid_type_error: "Must be a number" })
      .nonnegative("Advance cannot be negative")
      .refine(decimalTwoPlaces, "Cannot exceed 2 decimal places"),

    balance: z.coerce
      .number({ required_error: "Balance is required", invalid_type_error: "Must be a number" })
