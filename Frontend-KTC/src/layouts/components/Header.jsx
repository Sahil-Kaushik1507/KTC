  ...
  return (
    <div className="nav-bar bg-[#1E3A8A] w-full flex items-center h-14 px-6 border-b-4 border-[#FBBF24] shadow-lg">
      ...
      <div className="flex space-x-6 text-[#38BDF8] font-semibold pr-20">
        <button className="hover:text-[#E0F2FE] transition duration-300" onClick={handleHomeClick}>Home</button>
        <button className="hover:text-[#E0F2FE] transition duration-300" onClick={handleClick}>{isAuthenticated?"Logout":"Login"}</button>
      </div>
    </div>
  );
}
