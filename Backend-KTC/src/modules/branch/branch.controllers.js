...
import { addBranch,addBranchManager, viewBranches,viewBranchDetails } from "./branch.models.js"
...
export const viewAllBranches = asyncHandler(async (req, res) => {

    const branches = await viewBranches();
